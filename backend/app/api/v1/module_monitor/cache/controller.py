...
@CacheRouter.get("/info", summary="获取缓存监控信息", response_model=ResponseSchema[CacheMonitorSchema], dependencies=[Depends(AuthPermission(["module_monitor:cache:query"]))])
...
@CacheRouter.get("/get/names", summary="获取缓存名称列表", response_model=ResponseSchema[list[CacheInfoSchema]], dependencies=[Depends(AuthPermission(["module_monitor:cache:query"]))])
...
@CacheRouter.get("/get/keys/{cache_name}", summary="获取缓存键名列表", response_model=ResponseSchema[list[CacheInfoSchema]], dependencies=[Depends(AuthPermission(["module_monitor:cache:query"]))])
...
@CacheRouter.get("/get/value/{cache_name}/{cache_key}", summary="获取缓存值", response_model=ResponseSchema[CacheInfoSchema], dependencies=[Depends(AuthPermission(["module_monitor:cache:query"]))])
...
@CacheRouter.delete("/delete/name/{cache_name}", summary="清除指定缓存名称的所有缓存", response_model=ResponseSchema[None], dependencies=[Depends(AuthPermission(["module_monitor:cache:delete"]))])
...
@CacheRouter.delete("/delete/key/{cache_key}", summary="清除指定缓存键", response_model=ResponseSchema[None], dependencies=[Depends(AuthPermission(["module_monitor:cache:delete"]))])
...
@CacheRouter.delete("/clear", summary="清除所有缓存", response_model=ResponseSchema[None], dependencies=[Depends(AuthPermission(["module_monitor:cache:delete"]))])
