...
@ServerRouter.get("/info", summary="查询服务器监控信息", response_model=ResponseSchema[ServerMonitorSchema], dependencies=[Depends(AuthPermission(["module_monitor:server:query"]))])
