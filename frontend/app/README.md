<div align="center">
  ...
  <h1 align="center">
    FastApp
    <sup style="background-color: #28a745; color: white; padding: 2px 6px; border-radius: 3px; font-size: 0.4em; vertical-align: super; margin-left: 5px;">v2.0.0</sup>
  </h1>
  <p align="center">
...
- 🐂 [Wot UI](https://github.com/Moonofweisheng/wot-design-uni) - 基于 Vue3 + TypeScript 的 uni-app 组件库，70+ 高质量组件，支持国际化与暗黑模式
- 🚦 [@wot-ui/router](https://github.com/wot-ui/my-uni) - 适用于 uni-app & vue3 的轻量级路由库
- 🌐 [Alova](https://alova.js.org/zh-CN/) - 极致高效的请求工具集
- 🎨 [UnoCSS](https://github.com/unocss/unocss) - 高性能原子化 CSS 引擎
...
- [uni-helper](https://github.com/uni-helper) - uni-app 开发体验优化
- [vitesse-uni-app](https://github.com/uni-helper/vitesse-uni-app) - 快速起手项目
- [uni-ku](https://uni-ku.js.org/) - uni-app 插件库
